  ...
  return (
    <Card className="h-[340px]">
      ...
      <ResponsiveContainer width="100%" height="78%">
        <AreaChart data={data}>
          <defs><linearGradient id="sales" x1="0" y1="0" x2="0" y2="1"><stop offset="5%" stopColor="#fb923c" stopOpacity={0.55} /><stop offset="95%" stopColor="#fb923c" stopOpacity={0} /></linearGradient></defs>
          ...
          <Area type="monotone" dataKey="vendas" stroke="#fb923c" fill="url(#sales)" strokeWidth={3} />
        </AreaChart>
      </ResponsiveContainer>
    </Card>
  )
